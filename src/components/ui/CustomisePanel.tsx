      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-80 bg-black/90 backdrop-blur-3xl border-l border-white/10 z-[200] p-6 shadow-[-20px_0_50px_rgba(0,0,0,0.5)] overflow-y-auto"
          >
