  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden grid-overlay">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, transparent 40%, rgba(0,0,8,0.7) 100%)",
        }}
      />
      ...
      >
        <div className="flex items-center gap-2 justify-center mb-1">
          ...
          <span className="font-mono text-xs text-space-cyan/40 tracking-widest">
            v1.1 // MULTIVERSE VIEW
          </span>
          <div className="w-8 h-px bg-space-cyan/30" />
        </div>
        <h1 className="font-orbitron font-black text-4xl text-white tracking-tight">
          STACK <span className="text-space-cyan text-glow-cyan">UNIVERSE</span>
        </h1>
      ...
      >
        {isWarping
          ? "WARPING COMPUTE IN PROGRESS..."
          : "↑ CLICK DEEP SPACE FOR RANDOM"}
      </motion.p>
